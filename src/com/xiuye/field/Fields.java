...
public final class Fields {
	...
	public Fields(int access_flags, int name_index, int descriptor_index) {
		this.access_flags = access_flags;
		this.name_index = name_index;
		this.descriptor_index = descriptor_index;
		this.attributes = new Attributes();
	}
	public Fields(int access_flags, int name_index, int descriptor_index, Attributes attributes) {
		this.access_flags = access_flags;
		this.name_index = name_index;
		this.descriptor_index = descriptor_index;
